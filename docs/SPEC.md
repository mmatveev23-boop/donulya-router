...
«Зачёт касания» для светофора сделки — это **другая метрика**, считается отдельно AI-пайплайном (см. regulation Часть 4). С 2026-05-18 для звонка нужны **3 условия одновременно**: длительность ≥60 сек + AI-балл ≥5/10 + продвижение в карточке. Это защита от «формальных касаний» (поговорил 70 сек ни о чём для статистики).
